...
In this chapter, we present three strategies to select different \glspl{os} to be part of a \gls{bft} replicated system.
These strategies leverage on the data that is available on the vulnerability database developed in a previous work.
...
From both works, we selected 2563 vulnerabilities from a total of more than 44,000 vulnerabilities published by \gls{nvd}.
...
In this study, we consider two possible server machine setups offering an increasingly more secure platform and we cover the vulnerabilities in the period of 1994 to 2011. 
