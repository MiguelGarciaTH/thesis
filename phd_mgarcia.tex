...
\newcommand{\AnoLectivo}{2018/2019}
\newcommand{\Ano}{\Large{2019}}
...
% Comentar/descomentar conforme conveniente
\newcommand{\Especialidade}{Especialidade em Ci\^{e}ncia da Computa\c{c}\~{a}o}
...
\pagestyle{plain}				% display just page numbers
\include{chapters/abstract/resumo_estendido_pt}
\cleardoublepage
...
\include{chapters/relatedwork/related_work}
\include{chapters/datasource/datasource}
\include{chapters/sieveq/sieveq}
\include{chapters/lazarus/lazarus_design}
\include{chapters/lazarus/lazarus_implementation}
