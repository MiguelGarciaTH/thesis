...
plot 'baseline_10000.dat' using 2:xtic(1) t "Baseline" w histogram linecolor rgb "#ffffff",\
	'KMP_5_10000.dat' using 2:xtic(1) t "KMP-5" w histogram linecolor rgb "#cccccc", \
	'KMP_10_10000.dat' using 2:xtic(1) t "KMP-10" w histogram linecolor rgb "#666666",\
	'KMP_20_10000.dat' using 2:xtic(1) t "KMP-20" w histogram linecolor rgb "#000000",\
