...
\newcommand{\sender}{{sender-SQ}\xspace}
\newcommand{\Sender}{{Sender-SQ}\xspace}
\newcommand{\senders}{{sender-SQs}\xspace}
\newcommand{\Senders}{{Sender-SQs}\xspace}
\newcommand{\presieve}{{pre-SQ}\xspace}
\newcommand{\Presieve}{{Pre-SQ}\xspace}
\newcommand{\Presieves}{{Pre-SQs}\xspace}
\newcommand{\presieves}{{pre-SQs}\xspace}
\newcommand{\repsieve}{{replica-SQ}\xspace}
\newcommand{\Repsieve}{{Replica-SQ}\xspace}
\newcommand{\repsieves}{{replica-SQs}\xspace}
\newcommand{\Repsieves}{{Replica-SQs}\xspace}
\newcommand{\postsieve}{{post-SQ}\xspace}
\newcommand{\Postsieve}{{Post-SQ}\xspace}
